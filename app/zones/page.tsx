      ...
      <PageSection className="min-h-screen">
        <PageContainer>
          ...
          <p className="mx-auto mb-8 max-w-xl text-center text-sm text-gray-600">
            Klik op een zone voor details en foto&apos;s — of deel zelf een snapshot via de stappen
            hieronder.
          </p>

          <ZonePhotoHowTo variant="overview" />

          <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
            {zones.length === 0 ? (
              <p className="col-span-full text-center text-gray-600">Geen zones gevonden.</p>
            ) : (
